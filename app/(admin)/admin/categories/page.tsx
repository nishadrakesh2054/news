...
export default function AdminCategoriesPage() {
  ...
  return (
    <div className="w-full space-y-6 px-6 py-4 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border/60 pb-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground pt-1">
            Manage English and Nepali portal news categories and display ordering
          </p>
        </div>
      ...
      <div className="bg-card rounded-xl border border-border p-3 shadow-2xs flex items-center justify-between gap-3">
        <div className="relative min-w-55 max-w-xs flex-1">
